...
| `overfit_batches`         | `int`                                          | `0`                                    | Number of batches to overfit on for debugging. Uses the same batch for both training and validation. Useful for testing visualizers, configs, or verifying model learning. Set `seed` for reproducibility    |

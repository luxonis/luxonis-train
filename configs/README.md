...
| `use_balanced_image_logging` | `bool`                                         | `True`                                 | Whether to use balanced image logging based on class distribution. May result in fewer images being logged than `n_log_images`                   |
| `log_sub_losses`             | `bool`                                         | `True`                                 | Whether to log sub-losses for each loss node                                                                                                     |
...
trainer:
  ...
  n_log_images: 8
  use_balanced_image_logging: true

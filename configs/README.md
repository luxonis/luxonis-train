...
| Key          | Type                                                 | Default value | Description                                                                                                                                                                                                                                                                              |
| ------------ | ---------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `parameters` | `list[ParameterPattern] \| ParameterPattern \| None` | `None`        | Which parameters to apply the finetuning configuration to. If `None`, the configuration is applied to all parameters of the node. The `ParameterPattern` can contain `name` or `module_type` keys that are matched against the individual parameters. Regular expressions are supported. |

...
| `log_sub_metrics`         | `bool`                                         | `True`                                 | Log all sub-metrics. If set to False, only the main metric will be logged. For example, if True, metrics like mAP and F1 score will be logged while sub-metrics like mAP_small mAR_small will be skipped |

...
| `calibration_num_images`   | `int \| None`                                     | `None`                                                         | Number of validation images to use for PTQ calibration. If unset, PTQ uses the full validation split. This is independent of `trainer.n_validation_batches`, which still controls validation/test evaluation.                                        |

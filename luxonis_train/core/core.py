...
class LuxonisModel:
    ...
    def __init__(
        ...
        *,
        ...
        if weights is not None:
            ...
            cfg, dataset_metadata = self._restore_cfg_and_metadata(
                ckpt, cfg, dataset_metadata
            )
    ...
    ) -> tuple[PathType | Params | Config, DatasetMetadata | None]:
        if cfg is None:
            cfg = ckpt.get("config")
            if cfg is None:
                raise ValueError(

...
class AdaptiveDetectionLoss(BaseLoss):
    r"""Adaptive bbox detection loss with warmup assignment.
    ...
    Inputs:
        ...
        - ``target`` (``Tensor``): :math:`\left[N, 6\right]`, ``[batch,
    ...
    Notes:
        Caches anchors, anchor points, strides, and bbox scaling tensors
        from the first feature-map batch.

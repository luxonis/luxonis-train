...
class PrecisionDFLDetectionLoss(BaseLoss):
    r"""Precision bbox loss with distribution focal regression.
    ...
    Notes:
        Caches anchor points, stride tensors, bbox scaling tensors, and
        projection bins from the attached node.

...
for _loss_name in EMBEDDING_LOSSES:
    ...
    class EmbeddingLossWrapper(BaseLoss, register_name=_loss_name):
        r"""Wrapper for pytorch-metric-learning embedding losses.
        ...
        Notes:
            Registers one concrete loss per name in ``EMBEDDING_LOSSES``
            and exposes the selected registry name via the ``name``
            property.

...
class DetectionConfusionMatrix(BaseMetric):
    r"""Confusion matrix for detection-style predictions.
    ...
    Notes:
        Reports Matthews correlation coefficient from the accumulated
        confusion matrix.
    ...
    def __init__(self, iou_threshold: float = 0.45, **kwargs):
        ...
        Args:
            iou_threshold (float): The IoU a prediction needs to count as
                a match for a ground truth box.

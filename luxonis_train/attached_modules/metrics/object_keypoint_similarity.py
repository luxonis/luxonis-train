...
class ObjectKeypointSimilarity(BaseMetric):
    ...
    Notes:
        For FOMO, derives target keypoints from bbox centers and does
        not require explicit keypoint targets.

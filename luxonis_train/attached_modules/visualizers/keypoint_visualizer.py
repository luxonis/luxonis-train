...
class KeypointVisualizer(BBoxVisualizer):
    r"""Visualize instance keypoints with optional bounding boxes.
    ...
    Notes:
        Reuses bounding box visualization and draws keypoints, optional
        skeleton connections, and optional indices.

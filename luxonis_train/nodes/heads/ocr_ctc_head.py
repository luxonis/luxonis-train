...
from luxonis_train.utils import OCREncoder, OCRDecoder
...
class OCRCTCHead(BaseHead[Tensor, Tensor]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        @see: U{Adapted from <https://github.com/PaddlePaddle/PaddleOCR/blob/main/ppocr/modeling/heads/rec_ctc_head.py>}
        ...
        @param mid_channels: Number of middle channels. Defaults to None.
        @type return_feats: bool
        @param return_feats: Whether to return features. Defaults to False.
        """

...
class OCRCTCHead(BaseHead):
    ...
    Outputs:
        ...
        - export:
          ...
          - ``Tensor``: :math:`\left[B, T, n_{classes}\right]` softmax
            probabilities
    ...
    Notes:
        Converts convolutional features to a sequence and applies one or
        two linear layers for CTC character predictions.

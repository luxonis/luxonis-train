...
class BaseHead(BaseNode):
    ...
    Attributes:
        parser: Parser to use for the head.
    ...
    def annotate(
        ...
        Data should be in standard `luxonis-ml record format
        <https://github.com/luxonis/luxonis-ml/blob/main/luxonis_ml/data/README.md>`_.

        Args:
            head_output: Raw outputs from this head.
            image_paths: List of original image file paths to annotate.
            config_preprocessing: Config containing train_image_size,
                keep_aspect_ratio, etc.

        Returns:
            Iterator yielding annotation records in luxonis-ml format.

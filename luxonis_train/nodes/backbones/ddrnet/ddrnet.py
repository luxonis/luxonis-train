...
class DDRNet(BaseNode):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            channels: Base number of channels. If provided, overrides
                the variant values.
            high_resolution_channels: Number of channels in the high
                resolution net. If provided, overrides the variant
                values.
            use_aux_heads: Whether to use auxiliary heads. Defaults to
                True.
            upscale_module: Module for upscaling (e.g., bilinear
                interpolation). Defaults to UpscaleOnline().
            spp_width: Width of the branches in the SPP block. Defaults
                to 128.
            ssp_interpolation_mode: Interpolation mode for the SPP
                block. Defaults to "bilinear".
            segmentation_interpolation_mode: Interpolation mode for the
                segmentation head. Defaults to "bilinear".
            block: type of block to use in the backbone. Defaults to
                ResNetBlock.
            skip_block: type of block for skip connections. Defaults to
                ResNetBlock.
            layer5_block: type of block for layer5 and layer5_skip.
                Defaults to Bottleneck.
            layer5_bottleneck_expansion: Expansion factor for
                Bottleneck block in layer5. Defaults to 2.
            spp_kernel_sizes: Kernel sizes for the SPP module pooling.
                Defaults to [1, 5, 9, 17, 0].
            spp_strides: Strides for the SPP module pooling. Defaults to
                [1, 2, 4, 8, 0].
            layer3_repeats: Number of times to repeat the 3rd stage.
                Defaults to 1.
            layers: Number of blocks in each layer of the backbone.
                Defaults to [2, 2, 2, 2, 1, 2, 2, 1].
    ...
    def forward(self, inputs: Tensor) -> list[Tensor]:
        r"""Extract a multi-scale DDRNet feature pyramid.

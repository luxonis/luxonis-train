...
class ContextSpatial(BaseNode):
    r"""BiSeNetV1-style context-spatial backbone for segmentation.
    ...
    Notes:
        Builds the context path from a registry node or provided module
        and fuses it with a local spatial path.

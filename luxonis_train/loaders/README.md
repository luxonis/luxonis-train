...
| `class_order_per_task`  | `dict[str, List[str]] \| None`                                                                            | `None`        | Dictionary mapping task names to a list of class names. If provided, the classes for the specified tasks will be reordered.                                                                                                                                                                                |
| `kpts_mapping_per_task` | `dict[str, list[int]] \| None`                                                                            | `None`        | Dictionary mapping task names to custom keypoint mappings. If provided, the keypoints for the specified tasks will be reordered.                                                                                                                                                                           |

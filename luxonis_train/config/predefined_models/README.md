...
For best validation accuracies, choosing a **small `conf_thresh` (e.g., 0.03)** and a **high `iou_thresh` (e.g., 0.65)** can provide an additional few percentage points in the mAP metric.
